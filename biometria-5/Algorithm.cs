    ...
    public static Bitmap FloodFill(Bitmap bitmap, int x, int y, int thresholdMax, int maxPixels, bool isGlobal)
        {
            ...
            while (pixels.Count > 0 && pixelCount < maxPixels)
            {
                ...
                {
                    pixelCount++;
                    if (vs[a.X * 3 + a.Y * bitmap.Width * 3] >= vs[x + y * bitmap.Width * 3] - thresholdMax && vs[a.X * 3 + a.Y * bitmap.Width * 3] <= vs[x + y * bitmap.Width * 3] + thresholdMax
                        && vs[a.X * 3 + a.Y * bitmap.Width * 3 + 1] >= vs[x + y * bitmap.Width * 3 + 1] - thresholdMax && vs[a.X * 3 + a.Y * bitmap.Width * 3 + 1] <= vs[x + y * bitmap.Width * 3 + 1] + thresholdMax
                        && vs[a.X * 3 + a.Y * bitmap.Width * 3 + 2] >= vs[x + y * bitmap.Width * 3 + 2] - thresholdMax && vs[a.X * 3 + a.Y * bitmap.Width * 3 + 2] <= vs[x + y * bitmap.Width * 3 + 2] + thresholdMax)
                    {
